package parsing;//package com.github.zabetak.calcite.tutorial;

//import org.apache.calcite.rex.RexBuilder;
//import org.apache.calcite.sql2rel.StandardConvertletTable;
//
//public class StandardConvertletTablePlus {
//    public StandardConvertletTablePlus(RexBuilder rexBuilder){
//
//    }
//}
...
// */
public class StandardConvertletTablePlus extends ReflectiveConvertletTable {


    /** Singleton instance. */
    public static final StandardConvertletTablePlus INSTANCE =
            new StandardConvertletTablePlus();

    public static class ConfigBuilder{

        private StandardConvertletTablePlus convertletTable;

        public ConfigBuilder(){
            convertletTable = StandardConvertletTablePlus.INSTANCE;
        }
    }
    ...
    private StandardConvertletTablePlus() {
        super();
        this.rexCall = INSTANCE.rexCall;
        SqlStdOperatorTableNew sqlStdOperatorTableNew = new SqlStdOperatorTableNew();
        ...
        registerOp(SqlStdOperatorTable.MINUS,
                (cx, call) -> {
                    final RexCall e =
                            (RexCall) StandardConvertletTablePlus.this.convertCall(cx, call);
        ...
        registerOp(SqlLibraryOperators.NVL, StandardConvertletTablePlus::convertNvl);
        registerOp(SqlLibraryOperators.DECODE,
                StandardConvertletTablePlus::convertDecode);
        registerOp(SqlLibraryOperators.IF, StandardConvertletTablePlus::convertIf);
        ...
        registerOp(SqlStdOperatorTable.INTERVAL,
                StandardConvertletTablePlus::convertInterval);
        ...
        if (false) {
            registerOp(SqlStdOperatorTable.ELEMENT,
                    (cx, call) -> {
                        ...
                        return StandardConvertletTablePlus.this.convertCall(cx, call);
                    });
        }
    ...
    protected RexNode convertCast(
            @UnknownInitialization StandardConvertletTablePlus this,
            SqlRexContext cx,
            final SqlCall call) {
...
//    public RexNode convertSwappables(@UnknownInitialization StandardConvertletTablePlus this, SqlRexContext cx, SqlCall call){
